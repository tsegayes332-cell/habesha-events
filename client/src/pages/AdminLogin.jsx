...
const AdminLogin = () => {
  ...
  return (
    <div className="min-h-screen bg-habesha-white relative overflow-hidden">
      <Helmet>
        <title>Admin Login - Habesha Events</title>
      </Helmet>
          ...
          <div className="hidden lg:block">
            <div className="max-w-xl">
              ...
              <h1 className="mt-6 text-6xl font-playfair font-black leading-[0.95] text-imperial-green">
                Calm control for the loud part of the site.

              </h1>
              <p className="mt-6 text-base leading-relaxed text-charcoal/58">
                Review submissions, approve strong events, and keep the platform sharp without dragging public-site chrome into the workflow.
              </p>
            </div>
          </div>
          ...
          <div className="editorial-panel rounded-[34px] p-8 md:p-10 lg:p-12 max-w-xl w-full lg:justify-self-end">
            ...
            <div className="mt-8">
              ...
              <p className="mt-3 text-sm leading-relaxed text-charcoal/55">
                Use the admin account to review pending events and manage publication status.
              </p>
            </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    placeholder="admin@habeshaevents.com"
            ...
            <div className="mt-8 pt-8 border-t border-imperial-green/10 text-center">
              <p className="text-sm text-charcoal/50">
                ...
                <Link to="/admin/signup" className="font-bold text-gold hover:text-imperial-green transition-colors">
                  Sign up here
                </Link>
              </p>
            </div>
